...
def main():
    ...
    example_mp("fancy_ProDMP/AirHockey-7dof-hit-airhockit2023-dense-rew-discrete-penalty-v0", seed=10, iterations=200, render=False)
    #example_mp("fancy/AirHockey-7dof-hit-v0", seed=10, iterations=20, render=render)
    #example_mp("fancy/AirHockey-3dof-hit", seed=10, iterations=1000, render=True)
    #example_mp("fancy_ProDMP/AirHockey-3dof-hit-dense-rew-discrete-penalty-v0", seed=10, iterations=10, render=True)
    #example_mp("fancy/AirHockey-3dof-hit-dense-rew-discrete-penalty-v0", seed=10, iterations=1000, render=True)
